...
#define instantiate_gemm_splitk_g16(tname, trans_a, trans_b, iname, itype, oname, otype, bm, bn, bk, wm, wn) \
  instantiate_kernel(                                                                                         \
      "steel_gemm_splitk_nax_" #tname "_"  #iname "_" #oname                                                  \
      "_bm" #bm "_bn" #bn "_bk" #bk "_wm" #wm "_wn" #wn "_g16",                                               \
  gemm_splitk_nax, itype, bm, bn, bk, wm, wn, trans_a, trans_b, float, mlx::steel::NAXFrag32)
...
#define instantiate_gemm_splitk_transpose_helper_g16(iname, itype, oname, otype, bm, bn, bk, wm, wn) \
    instantiate_gemm_splitk_g16(nn, false, false, iname, itype, oname, otype, bm, bn, bk, wm, wn) \
    instantiate_gemm_splitk_g16(nt, false, true , iname, itype, oname, otype, bm, bn, bk, wm, wn) \
    instantiate_gemm_splitk_g16(tn, true , false, iname, itype, oname, otype, bm, bn, bk, wm, wn) \
    instantiate_gemm_splitk_g16(tt, true , true , iname, itype, oname, otype, bm, bn, bk, wm, wn)
...
#define instantiate_gemm_splitk_shapes_helper_g16(iname, itype, oname, otype) \
    instantiate_gemm_splitk_transpose_helper_g16(iname, itype, oname, otype,  64,  64, 256, 2, 2) \
    instantiate_gemm_splitk_transpose_helper_g16(iname, itype, oname, otype, 128, 128, 512, 4, 4)
...
instantiate_gemm_splitk_shapes_helper_g16(float16, half, float32, float);
instantiate_gemm_splitk_shapes_helper_g16(bfloat16, bfloat, float32, float);
instantiate_gemm_splitk_shapes_helper_g16(float32, float, float32, float);
// clang-format on
